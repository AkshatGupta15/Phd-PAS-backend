...
func companySignUpHandler(mail_channel chan mail.Mail) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		mail_channel <- mail.GenerateMail(signupReq.Email,
			...
			"Dear "+signupReq.Name+",\n\nWe got your request for registration on PhD Recruitment Automation System, IIT Kanpur. We will get back to you soon. For any queries, please get in touch with us at spo@iitk.ac.in.")
